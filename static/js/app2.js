...
function createDropdown(id, dataSource, includeBrandName = true, placeholder = "Search...", isDeletable = true) {
    ...
    dataSource.forEach((item) => {
        ...
        // Add click event to toggle the checkbox icon and move selected options to the top
        option.addEventListener("click", () => {
            if (checkboxIcon.src.includes("empty.png")) {
                checkboxIcon.src = "/static/assets/filled.png"; // Change to filled checkbox
                // Move the option to the top of the list
                dropdownList.insertBefore(option, dropdownList.firstChild);
            } else {
                checkboxIcon.src = "/static/assets/empty.png"; // Change to empty checkbox
                // Option can remain where it was, or you can optionally move it back
            }
        });
